...
The processing module bridges [extraction](../extraction/index.qmd) and [graph analysis](../acg/index.qmd). It takes annotated causal relations — whether produced manually or by [C-BERT](../extraction/c-bert.qmd) — and transforms them into quantitative, aggregated representations suitable for corpus-level analysis.
...
- Back to **[Extraction](../extraction/index.qmd)** — how annotations are produced
