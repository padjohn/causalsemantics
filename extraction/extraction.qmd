...
Hence, Causal Relation Extraction (CRE) has to identify these components – classify them in terms of polarity and salience – and apply those values to variable syntactic scopes. 
