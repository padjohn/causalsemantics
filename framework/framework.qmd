...
2. **[Extraction Methods](../extraction/extraction.qmd)**: How to identify causal relations in text
3. **[Processing Pipeline](../processing/processing.qmd)**: From annotations to tuples to graphs
